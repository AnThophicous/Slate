...
Binding N-API oficial da Slate 2.3.0, compilado em Rust para Node.js. O addon expõe renderização ANSI, eventos de teclado e mouse, resize, paste, mudanças de foco e os controles de ciclo de vida do terminal.

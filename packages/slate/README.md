...
Facade TypeScript estável da Slate 2.3.0. O pacote fornece renderização ANSI com fallback, binding nativo opcional, eventos unificados, nós imperativos, widgets, sinais básicos e controles de terminal.
